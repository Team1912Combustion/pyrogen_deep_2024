...
import org.team1912.pyrogen.pyrolib.stampede.DriveTo;
import org.team1912.pyrogen.pyrolib.stampede.Stampede;
...
public class AutoStampede extends OpMode {
    boolean isRed = false;
    ...
    public void init() {
        ...
        */
        ...
        //x, y, heading for start positions
        drivePositionsAudienceRed.put("start", new double[]{0, 0, 0});
        drivePositionsAudienceBlue.put("start", new double[]{0, 0, 0});
        drivePositionsBackRed.put("start", new double[]{0, 0, 0});
        drivePositionsBackBlue.put("start", new double[]{0, 0, 0});

        drivePositionsAudienceRed.put("Position 1", new double[]{0, 12, 0});
        drivePositionsAudienceBlue.put("Position 1", new double[]{0, 12, 0});
        drivePositionsBackRed.put("Position 1", new double[]{0, 12, 0});
        drivePositionsBackBlue.put("Position 1", new double[]{0, 12, 0});

        drivePositionsAudienceRed.put("Position 2", new double[]{12, 12, 90});
        drivePositionsAudienceBlue.put("Position 2", new double[]{12, 12, 90});
        drivePositionsBackRed.put("Position 2", new double[]{12, 12, 90});
        drivePositionsBackBlue.put("Position 2", new double[]{12, 12, 90});
    ...
    public void start() {
        ...
        stampede.setOrientation(stampede.headingField);
    }
    ...
    public void loop() {
        ...
        telemetry.addData("IMU Orientation", "IMU %.2f", stampede.getOrientation());
