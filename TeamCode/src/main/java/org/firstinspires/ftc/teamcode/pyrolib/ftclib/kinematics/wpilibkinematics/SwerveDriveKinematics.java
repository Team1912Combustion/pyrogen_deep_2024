...
public class SwerveDriveKinematics {
    private final Matrix m_inverseKinematics;
    ...
    public SwerveDriveKinematics(Translation2d... wheelsMeters) {
        ...
        m_inverseKinematics = new Matrix(m_numModules * 2, 3);
    ...
    public SwerveModuleState[] toSwerveModuleStates(ChassisSpeeds chassisSpeeds,
        ...
        Matrix moduleStatesMatrix = m_inverseKinematics.times(chassisSpeedsVector);
    ...
    public ChassisSpeeds toChassisSpeeds(SwerveModuleState... wheelStates) {
        ...
        Matrix moduleStatesMatrix = new Matrix(m_numModules * 2, 1);
        ...
        Matrix chassisSpeedsVector = m_forwardKinematics.times(moduleStatesMatrix);
