...
package org.firstinspires.ftc.teamcode.pyrolib.ftclib.spline;
...
public abstract class Spline {
     ...
     */
    protected abstract Matrix getCoefficients();
    ...
    public PoseWithCurvature getPoint(double t) {
        Matrix polynomialBases = new Matrix(m_degree + 1, 1);
        final Matrix coefficients = getCoefficients();
        ...
        Matrix combined = coefficients.times(polynomialBases);
