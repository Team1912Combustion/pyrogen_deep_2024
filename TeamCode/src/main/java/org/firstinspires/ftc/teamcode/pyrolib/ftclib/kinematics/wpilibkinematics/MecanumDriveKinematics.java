...
package org.firstinspires.ftc.teamcode.pyrolib.ftclib.kinematics.wpilibkinematics;
...
public class MecanumDriveKinematics {
    private Matrix m_inverseKinematics;
    private final Matrix m_forwardKinematics;
    ...
    public MecanumDriveWheelSpeeds toWheelSpeeds(ChassisSpeeds chassisSpeeds,
        ...
        Matrix chassisSpeedsVector = new Matrix(3, 1);
        chassisSpeedsVector.setColumn(0, 0,
                chassisSpeeds.vxMetersPerSecond, chassisSpeeds.vyMetersPerSecond,
                chassisSpeeds.omegaRadiansPerSecond);

        Matrix wheelsMatrix = m_inverseKinematics.times(chassisSpeedsVector);
    ...
    public ChassisSpeeds toChassisSpeeds(MecanumDriveWheelSpeeds wheelSpeeds) {
        Matrix wheelSpeedsMatrix = new Matrix(4, 1);
        ...
        Matrix chassisSpeedsVector = m_forwardKinematics.times(wheelSpeedsMatrix);
    ...
    private void setInverseKinematics(Translation2d fl, Translation2d fr,
        ...
        m_inverseKinematics = m_inverseKinematics.times(1.0 / Math.sqrt(2));
    }
}
